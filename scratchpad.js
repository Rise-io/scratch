...
ScratchCard.prototype.init = function (canvasID) {
  ...
  // TODO: Load image only once, and re-use for all canvas
...
ScratchCard.prototype.clearCanvas = function () {
  ...
  //TODO: Add finished sparkling animation here
};
...
ScratchCard.prototype.resize = function () {
  console.warn("=> this.container", this.container.clientWidth, this.container.clientHeight);
};